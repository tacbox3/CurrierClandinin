...
# For a single TSeries, this batch file will bin data that has been oversampled in X, run brainss motion correction, then calculate a variance brain. For two channel imaging with a structural marker.
...
brain_mirror="${series_base}_channel_2_binned.nii"
